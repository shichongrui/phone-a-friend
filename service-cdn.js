...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.clientReadyStateChange = clientReadyStateChange;
	exports.on = on;
	
	var _Deferred = __webpack_require__(49);
	
	var handlers = {};
	
	var readyDeferred = new _Deferred.Deferred();
	...
	function clientReadyStateChange(isClientReady) {
	  if (isClientReady) {
	    readyDeferred.resolve();
	  } else {
	    readyDeferred = new _Deferred.Deferred();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _io = __webpack_require__(50);
	
	var io = _interopRequire(_io);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.putFileInCache = putFileInCache;
	exports.getFileFromCache = getFileFromCache;
	exports.getFileAsArrayBuffer = getFileAsArrayBuffer;
	exports.removeFileFromCache = removeFileFromCache;
	exports.havePeerManifest = havePeerManifest;
	exports.getUsersManifest = getUsersManifest;
	exports.getUserForFileFromManifest = getUserForFileFromManifest;
	exports.updateManifestForUser = updateManifestForUser;
	exports.removeManifestForUser = removeManifestForUser;
	exports.clearManifests = clearManifests;
	...
	function getHashForFile(url) {
	  return new Promise(function (resolve, reject) {
	    ...
	    _socket.socket.emit('hash', url, function (data) {
	...
	function putFileInCache(url, file, hash) {
	...
	function getFileAsArrayBuffer(url) {
	...
	function removeFileFromCache(url) {
	  console.log('removing %s from cache', url);
	  delete files[url];
	}
	
	function havePeerManifest(peerId) {
	  return !!peerManifests[peerId];
	}
	
	function getUsersManifest() {
	  return Object.keys(files);
	}
	
	function getUserForFileFromManifest(url) {
	...
	function updateManifestForUser(peerId, manifest) {
	...
	function removeManifestForUser(peerId) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var object = __webpack_require__(76);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getResponseThroughFetch(request) {
	  var shouldCache = arguments[1] === undefined ? true : arguments[1];
	...
	function getFileFromPeer(peerId, request) {
	  ...
	  return Promise.all([hashPromise, filePromise]).then(function (_ref) {
	    ...
	    return cache.isHash(hash, response.data.file).then(function (isValid) {
	      if (isValid) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getUsersManifest = getUsersManifest;
	exports.removeManifestForPeer = removeManifestForPeer;
	...
	function readyStateChange(req, res) {
	  messenger.clientReadyStateChange(req.ready);
	  _socket.socket.emit('record-peer-id', req.peerId);
	  if (!req.ready) {
	    _socket.socket.emit('remove-peer-id', req.peerId);
	...
	function getUsersManifest(req, res) {
	  res({
	    manifest: cache.getUsersManifest()
	  });
	}
	
	function removeManifestForPeer(req, res) {
	  cache.removeManifestForUser(req.peer);
	}
	
	function removeFromManifest(req, res) {
	  //first lets double check that this is the case
	  Promise.all([cache.getHashForFile(req.url), cache.getFileAsArrayBuffer(req.url)]).then(function (data) {
	    console.log(data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = minimatcher;
	
	var _minimatch = __webpack_require__(38);
	
	var minimatch = _interopRequire(_minimatch);
	
	function minimatcher(file, patterns) {
